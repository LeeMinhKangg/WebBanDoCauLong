...
export const mockProducts: Product[] = [
  {
    ...
    description:
      'Experience premium sound quality with these wireless headphones. Features noise cancellation, long battery life, and comfortable ear cups for extended listening sessions.',
