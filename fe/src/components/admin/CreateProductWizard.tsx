        ...
        return (
          <div className="space-y-6">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800/50 mb-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-600 dark:text-blue-400">
                    Thuộc tính giúp mô tả đặc điểm sản phẩm (như chất liệu, kích
                    thước). Biến thể cho phép bạn tạo các phiên bản khác nhau
                    của sản phẩm (như màu sắc, kích cỡ) với giá và số lượng
                    riêng.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              {attributes.length === 0 ? (
                <div className="text-center py-6 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-md border border-dashed border-gray-300 dark:border-gray-600">
            ...
            {/* Biến thể */}
            <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 mt-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-medium text-lg text-neutral-800 dark:text-neutral-200 flex items-center">
              ...
              {variants.length === 0 ? (
                <div className="text-center py-6 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-md border border-dashed border-gray-300 dark:border-gray-600">
                  <Square2StackIcon className="w-8 h-8 mx-auto mb-2 text-gray-400" />
