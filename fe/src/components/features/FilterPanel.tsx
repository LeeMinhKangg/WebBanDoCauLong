      ...
      {isMobile && (
        <div className="flex justify-between items-center mb-4 border-b border-neutral-200 dark:border-neutral-700 pb-3">
          ...
          <button
            ...
            aria-label={t('shop.filter.closeFilter')}
          >
            <svg
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            {[
              { label: t('shop.filter.pricePresets.under100k'), min: 0, max: 100000 },
              { label: t('shop.filter.pricePresets.100k500k'), min: 100000, max: 500000 },
              { label: t('shop.filter.pricePresets.500k1m'), min: 500000, max: 1000000 },
              { label: t('shop.filter.pricePresets.1m5m'), min: 1000000, max: 5000000 },
              { label: t('shop.filter.pricePresets.5m10m'), min: 5000000, max: 10000000 },
              { label: t('shop.filter.pricePresets.over10m'), min: 10000000, max: 100000000 },
            ].map((preset) => (
              <button
                key={preset.label}
                onClick={() => {
